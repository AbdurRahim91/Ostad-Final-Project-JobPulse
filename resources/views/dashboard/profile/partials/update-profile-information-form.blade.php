    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="card shadow-sm">
                <div class="card-body">
                    <h2 class="card-title text-center mb-4">{{ __('Profile Information') }}</h2>
                    <!-- <p class="card-text text-center text-muted">{{ __("Update your account's profile information and email address.") }}</p> -->
